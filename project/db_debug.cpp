...
int main() {
    ...
    SQLExecDirectA(sqlStmt, (SQLCHAR*)"SELECT user_id, username, role, IFNULL(block, 'NULL') FROM Users;", SQL_NTS);
    
    char id[20], name[100], role[50], block[50];
